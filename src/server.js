import fs from "fs";
// needed to integrate the front end to backend
import path from "path";
import admin from "firebase-admin";
import express from "express";
import { db, connectToDb } from "./db.js"; // import needs file extension
...
app.put("/api/articles/:name/upvote", async (req, res, next) => {
  const { name } = req.params;
